...
Vue.component("purple_hero_component_1721894475", {
    template: `
        ...
        <div id="section-container" class="relative max-w-6xl mx-auto px-4 sm:px-6 bg-white">
            <div id="hero-content-container" class="pt-32 pb-16 md:pt-52 md:pb-32">
                ...
                <div id="hero-content" class="max-w-3xl mx-auto text-center" style="position: relative;z-index: 1">
                    ...
                    <div class="flex" id="sub-hero-text-container"><p id="sub-hero-text" class="flex-1 text-lg mb-8" data-aos="fade-down" data-aos-delay="200" :class="landingPageSubHeroTextStyle">Get detailed analytics on the latest Ethereum transactions as they happen. Identify trends, track activity, and make informed decisions.</p></div>
